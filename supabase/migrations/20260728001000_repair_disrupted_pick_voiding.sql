-- Production-safe continuation of the manual repair in 042. This is
-- intentionally idempotent: CREATE OR REPLACE is safe whether or not the
-- original SQL Editor repair was run.
