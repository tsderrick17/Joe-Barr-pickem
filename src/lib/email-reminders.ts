  ...
  const recapImages = reminder.category === "weekly_recap" || reminder.category === "playoff_day_recap"
    ...
    : reminder.category === "weekly"
      ...
      : reminder.category === "early_lock"
        ...
        : "";
  const destination = reminder.category === "weekly_recap" || reminder.category === "playoff_day_recap" || reminder.category === "playoff_public_reveal" || reminder.category === "sunday_early_reveal" || reminder.category === "sunday_late_reveal" || reminder.category === "featured_window_reveal" ? siteUrl : `${siteUrl}/board`;
  const callToAction = reminder.category === "weekly_recap" || reminder.category === "playoff_day_recap" || reminder.category === "playoff_public_reveal" || reminder.category === "sunday_early_reveal" || reminder.category === "sunday_late_reveal" || reminder.category === "featured_window_reveal" ? "View standings" : "Open The Slate";
