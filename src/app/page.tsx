...
/* Keep the first paint shaped like the real Standings page while its signed-in
   data arrives. Show one Pick'em surface up front, avoiding duplicate blank
   cards and a visible jump without changing any pool behavior. */
