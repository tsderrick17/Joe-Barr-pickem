...
export default function ReminderAdminPage() {
  ...
  function applyPreset(preset: typeof presets[number]) { setForm((current) => ({ ...current, category: preset.category, audience: preset.audience, title: preset.title, body: preset.body })); }
