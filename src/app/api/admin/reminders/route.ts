...
const categories = new Set(["weekly", "final_lines", "sunday_final_lines", "early_lock", "pick_due", "weekly_recap", "playoff_day_recap", "sunday_early_reveal", "sunday_late_reveal", "featured_window_reveal", "ats_due", "survivor_due", "custom"]);
