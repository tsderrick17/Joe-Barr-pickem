  ...
  return <main className="min-h-screen bg-[#f5f0e6] px-4 py-8 text-[#171719] sm:px-6 sm:py-12"><div className="mx-auto max-w-3xl">
    ...
    <form className="mt-8 border-y-2 border-[#1d1d1f] py-6" onSubmit={save}>
      ...
      {enabled ? <div className="mt-7 space-y-8">
        ...
        <p className="border-l-2 border-[#16877f] bg-[#edf7f3] px-3 py-3 text-sm leading-5 text-slate-700"><strong className="text-[#163d3d]">Commissioner notes stay on.</strong> If pool email is enabled, important commissioner updates will reach you even if you turn off the optional categories above.</p>
      </div> : null}
