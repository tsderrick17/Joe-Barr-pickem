...
export default function ProfilePage() {
  ...
  return <main className="min-h-screen bg-[#f5f0e6] px-4 py-8 text-[#171719] sm:px-6 sm:py-12"><div className="mx-auto max-w-3xl">
    ...
    <form className="mt-8 border-y-2 border-[#1d1d1f] py-6" onSubmit={save}>
      ...
      {enabled ? <aside className="mt-4 border-l-4 border-[#007e72] bg-white px-4 py-3 text-sm leading-5"><strong className="block">Keep PickemJB out of spam</strong>Add <span className="break-all font-mono font-bold">{profile?.senderEmail || "the PickemJB From address shown in your email"}</span> to your contacts or safe-senders list.</aside> : null}
