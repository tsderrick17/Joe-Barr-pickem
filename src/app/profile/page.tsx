...
const essentials: Preferences = { weekly: false, finalLines: false, sundayFinalLines: false, earlyLock: true, pickDue: true, sundayEarlyReveal: false, sundayLateReveal: false, featuredWindowReveal: false, weeklyRecap: true, playoffDayRecap: false, playoffPublicReveal: false };
