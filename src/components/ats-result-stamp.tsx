 ...
 */
export default function AtsResultStamp({ result, className = "" }: { result: AtsResultMark; className?: string }) {
  ...
  return (
    <strong
      ...
      className={`relative -top-0.5 inline-block shrink-0 -rotate-[7deg] text-sm font-black leading-none ${mark === "W" ? "text-green-700" : "text-red-700"} ${className}`}
    >
      {mark}
    </strong>
  );
