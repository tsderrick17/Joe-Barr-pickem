    ...
    <section className="border-b-2 border-zinc-900 py-8">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-zinc-700">
            Detects failed or stale automation before it becomes a line-lock or scoring problem.
          </p>
        </div>
      ...
      {health ? (
        <div className={`mt-5 border p-4 ${health.status === "healthy" ? "border-green-800 bg-green-50 text-green-950" : "border-red-700 bg-red-50 text-red-950"}`}>
          ...
          ) : <p className="mt-1 text-sm">No overdue lines or stale scoring checks are currently detected.</p>}
